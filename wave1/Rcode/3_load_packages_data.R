...
setwd("/Users/e3cleary/Documents/WorldPop/India_project/data_analysis_feb23/india_mobility_wave1")
#getwd()
# install INLA
...
data_all <- fread("data/data_weekly_all_merged_wave1.csv", stringsAsFactors = F)
...
head(data)
#str(data_all)
unique(data_all$GID_2[is.na(data_all$mean_intra)==T])
