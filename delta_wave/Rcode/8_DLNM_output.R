...
# Plot
pdf(paste0("figs/", region_subset, "/fig_03a_GLH_association.pdf"), width=6, height=6)
par(mar = c(5, 4, 2, 4))
...
pdf(paste0("figs/", region_subset, "/fig_03b_GLH_contour.pdf"), width = 6, height = 6)
...
pdf(paste0("figs/", region_subset, "/fig_03c_GLH_scenario.pdf"), width = 6, height = 6)
...
mx <- which(round(vars, 2) == 0.8)
mx2 <- which(round(vars, 2) == 1.25)
...
## explore exposure lag response associations 
# Plot
pdf(paste0("figs/", region_subset, "/fig_03a_temp_association.pdf"), width=6, height=6)
par(mar = c(5, 4, 2, 4))
...
## contour plot of exposure-lag-response associations
pdf(paste0("figs/", region_subset, "/fig_03b_temp_contour.pdf"), width = 6, height = 6)
...
pdf(paste0("figs/", region_subset, "/fig_03c_temp_scenario.pdf"), width = 6, height = 6)
...
## explore exposure lag response associations 
# Plot
pdf(paste0("figs/", region_subset, "/fig_03a_prec_association.pdf"), width=6, height=6)
par(mar = c(5, 4, 2, 4))
...
## contour plot of exposure-lag-response associations
pdf(paste0("figs/", region_subset, "/fig_03b_prec_contour.pdf"), width = 6, height = 6)
...
pdf(paste0("figs/", region_subset, "/fig_03c_prec_scenario.pdf"), width = 6, height = 6)
...
## explore exposure lag response associations 
# Plot
pdf(paste0("figs/", region_subset, "/fig_03a_policy_association.pdf"), width=6, height=6)
par(mar = c(5, 4, 2, 4))
...
## contour plot of exposure-lag-response associations
pdf(paste0("figs/", region_subset, "/fig_03b_policy_contour.pdf"), width = 6, height = 6)
...
pdf(paste0("figs/", region_subset, "/fig_03c_policy_scenario.pdf"), width = 6, height = 6)
...
# get selected exposure variable positions
mn <- which(round(vars, 2) == 40)
mx <- which(round(vars, 2) == 60)
