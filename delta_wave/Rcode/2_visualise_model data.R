...
# load shape file 
map_all <- read_sf("shapefile/gadm36_IND_2.shp")
...
pdf(paste0("figs/", region_subset, "/map_01_region_state_pop_by_week.pdf"), width=8, height=10)
...
pdf(paste0("figs/", region_subset, "/map_01_temp_by_week.pdf"), height = 8, width = 12)
plot1
dev.off()
...
pdf(paste0("figs/", region_subset, "/map_01_humidity_by_week.pdf"), height = 8, width = 12)
plot1
dev.off()
...
pdf(paste0("figs/", region_subset, "/map_01_prec_by_week.pdf"), height = 8, width = 12)
plot1
dev.off()
...
pdf(paste0("figs/", region_subset, "/map_01_UV_by_week.pdf"), height = 8, width = 12)
plot1
dev.off()
...
pdf(paste0("figs/", region_subset, "/map_01_Stringency_by_week.pdf"), height = 8, width = 12)
plot1
dev.off()
...
pdf(paste0("figs/", region_subset, "/map_01_Mobility_by_week.pdf"), height = 8, width = 12)
plot1
dev.off()
...
pdf(paste0("figs/", region_subset, "/map_01_case_rate_by_week.pdf"), height = 8, width = 12)
plot1
dev.off()
