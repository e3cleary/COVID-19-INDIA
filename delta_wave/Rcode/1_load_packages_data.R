...
## wave2
data_all <- fread("data/data_weekly_all_merged_wave2", stringsAsFactors = F)
...
data.m <- data[,c("R0", "R", "ln_R", "cases", "cases_rate", 'cases_accu', 'cases_accu_rate',
                  "mean_intra", "d2m", "t2m", "tp", "uv",  "Stringency", 
...
# Temperature / fun 'ns' - Generate a Basis Matrix for Natural Cubic Splines
var <- lag_TEMP
